...
relationships, and therefore, it represents the relationships 
to other model instances with hyperlinks instead of primary key values. 
In addition, the HyperlinkedModelSerializer generates a field named url with the URL for the resource as its value. 
As happens with ModelSerializer, the HyperlinkedModelSerializer class provides default implementations for the create and update methods.
"""
